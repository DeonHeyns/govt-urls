...
3. [YAML](/_data/government_urls.yml)&mdash;a mapping of the hierarchal URLs file for applications (also in [JSON](http://gsa.github.io/govt-urls/government_urls.json)).
